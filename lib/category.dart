...
class _CategoryState extends State<Category> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(key: _scaffoldKey,backgroundColor: Colors.white10.withOpacity(0.95),drawer: buildContainer(context),appBar: AppBar(
      ...
      title: Text('Top Categories',
        style: GoogleFonts.poppins(fontWeight: FontWeight.w500, color:  Colors.white,fontSize: 18),
      ),
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          return ListView.builder(padding: EdgeInsets.only(top: 8),
            ...
            if(snapshot.hasData){
              return ListTile(title: Text('${snapshot.data.documents[index]['tag']}', style: GoogleFonts.poppins(fontWeight: FontWeight.w500),),
            ...
            child: Container(width: 110, height: 110,
              ...
              child: Neumorphic(
                ...
                child: ClipRRect(
                  ...
                  child: UserProvider.profile!= null && UserProvider.profile.isNotEmpty?CachedNetworkImage(
