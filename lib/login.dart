...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(key: _scaffoldKey,backgroundColor: Colors.green,
        ...
        child: Stack(
          children: [
            Align(alignment: Alignment.topCenter,child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.center,mainAxisSize: MainAxisSize.max,children: [
                SizedBox(height: 20,),
            ...
            child: Container(width: MediaQuery.of(context).size.width,
              ...
              child: Column(mainAxisSize: MainAxisSize.min,crossAxisAlignment: CrossAxisAlignment.start,children: [
                ...
                Padding(
                  ...
                  child: Text("Please enter your mobile number to send the OTP", style: GoogleFonts.poppins(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 16)),
                ),
                Padding(
                ...
                Center(
                  child: MaterialButton(elevation: 0,minWidth: MediaQuery.of(context).size.width*0.9,
                      height: 50,
                      color: Colors.green,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      child: Padding(padding: EdgeInsets.symmetric(vertical: 10.0, horizontal: 42.0),
            ...
            Align(alignment: Alignment.topCenter,child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.center,mainAxisAlignment: MainAxisAlignment.center,mainAxisSize: MainAxisSize.max,children: [
                Padding(
                  ...
                  child: Text("Verify Your Mobile Number", style: GoogleFonts.poppins(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 16)),
                ),
            ...
            Align(alignment: Alignment.bottomCenter,
              child: Container(width: MediaQuery.of(context).size.width,
                ...
                child: Column(mainAxisSize: MainAxisSize.min,crossAxisAlignment: CrossAxisAlignment.start,children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(12.0),
                    child: Text("Please enter OTP sent to your mobile number +91 ${_phone.text}", style: GoogleFonts.poppins(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 16)),
                  ),
                  SizedBox(height: 20,),
                  Center(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                          ...
                          child: Text("RESEND", style: GoogleFonts.poppins(color: Colors.green,fontWeight: FontWeight.bold,fontSize: 16),
                          )
                      )
                    ],
                  ),
