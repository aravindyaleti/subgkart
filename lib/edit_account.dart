              ...
              child: GestureDetector(
                child: ClipRRect(
                  ...
                  child: img!=null?Image.file(img):url!=null&&url.isNotEmpty?CachedNetworkImage(imageUrl: url,
                    fit: BoxFit.cover,):CircleAvatar(radius: 67, backgroundColor: Color(0xff6fb840),
            ...
            child: RaisedButton(elevation: 1,
              ...
              child: Ink(
                decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [Color(0xff6fb840),Color(0xff6fb840)],
                ...
                return Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(mainAxisSize: MainAxisSize.min,
                      ...
                      children: <Widget>[
                        ListTile(tileColor: Colors.green.shade50,
                          title: Text('Add delivery address',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.green),),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: MaterialButton(
                                ...
                                onPressed: () async{
                                  if(editName.text.isNotEmpty&&house.text.isNotEmpty&&locality.text.isNotEmpty){
                                    var v={
                                      'name':editName.text,
                                    ...
                                    Fluttertoast.showToast(msg: "Please enter all mandatory fields");
                                  }
