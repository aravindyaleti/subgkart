...
import 'package:subgkart/category.dart';
                ...
                if(snapshot.hasData){
                  return snapshot.data.documents.length>0?GestureDetector(
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          Positioned(top: 6,child: Icon(Icons.shopping_cart_outlined,color: Colors.grey)),
                          Positioned(top: 1,right: 0,left: 12,
                              child: Container(
                  ...
                  ):GestureDetector(child: Icon(Icons.shopping_cart_outlined,size: 25,color: Colors.grey.shade500), onTap: (){
                    // Navigator.push(context,MaterialPageRoute(builder: (BuildContext context) => Cart()));
                  });
                }
                return GestureDetector(child: Icon(Icons.shopping_cart_outlined,size: 25,color: Colors.grey.shade500), onTap: (){
                  // Navigator.push(context,MaterialPageRoute(builder: (BuildContext context) => Cart()));
                });
              }
          ),
