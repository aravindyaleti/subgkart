...
import 'package:subgkart/services/data.dart';
  ...
  Future _get()async{
    ...
    try{
      ...
      snapshot.documents.map((e){
        setState(() {
          cart.add(CartData(e.data['image'], e.data['name'], e.data['mrp'].toString(), e.data['price'].toString(),
              e.data['quantity'], e.data['count'], e.data['total'].toString(),e.documentID));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('My Cart',style: GoogleFonts.poppins(color: Colors.white),
        ),
      ),
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTile(title: 'Products Discount',tail: '-₹${mrp-total} OFF',
                    titlestyle: GoogleFonts.poppins(fontWeight: FontWeight.w500,color: Colors.grey),
                    tailstyle: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: Colors.green)),
          ...
          StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                return ListView.builder(itemCount: snapshot.data.documents.length, physics: BouncingScrollPhysics(),
      ...
      bottomNavigationBar: cart != null && cart.isNotEmpty
          ? ListTile(tileColor: Colors.green,title: Text('₹$total',
              ...
              trailing: Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () async {
                    ...
                    try {
                      QuerySnapshot snapshot = await reference.getDocuments();
                      await Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => Address('grocery', mrp, mrp-total, total,UserProvider.pincode,snapshot)));
                    }catch(e){
