...
import 'package:subgkart/successful.dart';
import 'Cart.dart';
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: ListTile(
                ...
                trailing: Icon(Icons.local_shipping_outlined, size: 40,color: Color(0xff6fb840),),
              ),
            ),
          ),
        ),
          ...
          child: Card(
            ...
            child: Container(
              child: Column(
                children: [
                  ListTile(
                    leading: Icon(Icons.local_shipping_outlined,size: 40,color: Color(0xff6fb840),),
                    title: Text(
                      'Cash On delivery',
