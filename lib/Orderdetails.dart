                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text.rich(TextSpan(text: '${format.format(DateTime.fromMicrosecondsSinceEpoch(widget.snapshot.data['booking']))}   ',style: GoogleFonts.poppins(),
                          children: [
                            TextSpan(text: '${time.format(DateTime.fromMicrosecondsSinceEpoch(widget.snapshot.data['booking']))}',)
                          ]))
                    ],
                  ),
                ),
